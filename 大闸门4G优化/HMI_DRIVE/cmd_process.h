...
#define MSG_GET_ICON_PRESS         0x26  //图标按下通知
...
{
    kCtrlUnknown=0x0,
    kCtrlButton=0x10,                     //按钮  10
    kCtrlText,                            //文本  11
    kCtrlProgress,                        //进度条 12
    kCtrlSlider,                          //滑动条 13
    kCtrlMeter,                            //仪表  14
    kCtrlDropList,                        //下拉列表 15
    kCtrlAnimation,                       //动画     16
    kCtrlRTC,                             //时间显示  17
    kCtrlGraph,                           //曲线图控件 18
    kCtrlTable,                           //表格控件   19
    kCtrlMenu,                            //菜单控件   1a
    kCtrlSelector,                        //选择控件   1b 
    kCtrlQRCode,                          //二维码
};
...
/*2023年1月4日11:21:12
图标按下通知*/
void NotifyICONPress(uint16 screen_id, uint16 control_id, uint8  state);
/*! 
*  \brief  文本控件通知
...
extern DateTimeDef tempDateTime;
extern volatile uint16 Last_screen_id;                                                         //上一个画面ID
extern volatile uint16 current_screen_id;                                                 //当前画面ID
/*消息处理函数*/
void CMD_Process(void);
#define SHOW_TITLE_LEN 20
#define SHOW_CONTENT_LEN 100
extern u8 show_title[SHOW_TITLE_LEN];
extern u8 show_content[SHOW_CONTENT_LEN];
#endif
